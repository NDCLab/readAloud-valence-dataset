...
build_full_passage_path <- function(passage_nickname, dir_root, participant_id)
  paste(sep = "",
...
# fixme to be the way we did it for passage level
# in particular, we probably dropped words not in corpus, right?
